...
import (
	...
	httpapi2 "github.com/faber-numeris/beholder/authn/internal/adapters/inbound/httpapi"
	"github.com/faber-numeris/beholder/authn/internal/adapters/outbound/mail"
	"github.com/faber-numeris/beholder/authn/internal/core/services"
	config2 "github.com/faber-numeris/beholder/authn/internal/infrastructure/config"
	"github.com/faber-numeris/beholder/authn/internal/infrastructure/postgres"
	...
	stopligtht "github.com/oaswrap/spec-ui/stoplight"
)
...
func buildRouter(handler api.ServerInterface, cfg config2.IServiceConfig) http.Handler {
	specuiHandler := specui.NewHandler(
		...
		specui.WithSpecGenerator(openAPISpecGenerator{}),
		stopligtht.WithUI(),
	)
