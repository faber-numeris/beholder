...
func (_m *MockUserRepository) Ping() bool {
	ret := _m.Called()
...
// MockUserRepository_Ping_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Ping'
type MockUserRepository_Ping_Call struct {
	*mock.Call
}

// Ping is a helper method to define mock.On call
func (_e *MockUserRepository_Expecter) Ping() *MockUserRepository_Ping_Call {
	return &MockUserRepository_Ping_Call{Call: _e.mock.On("Ping")}
}

func (_c *MockUserRepository_Ping_Call) Run(run func()) *MockUserRepository_Ping_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockUserRepository_Ping_Call) Return(_a0 bool) *MockUserRepository_Ping_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockUserRepository_Ping_Call) RunAndReturn(run func() bool) *MockUserRepository_Ping_Call {
	_c.Call.Return(run)
	return _c
}

// UpdatePassword provides a mock function with given fields: ctx, userID, passwordHash
func (_m *MockUserRepository) UpdatePassword(ctx context.Context, userID string, passwordHash string) error {
